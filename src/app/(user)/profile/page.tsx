...
const ProfilePage = () => {
  ...
  const [userData, setUserData] = useState({
    ...
    upcomingBookings: [
      { id: 1, turfName: 'Green Valley Turf', date: '2025-03-02', time: '18:00-19:00', status: 'confirmed' },
      { id: 2, turfName: 'City Central Field', date: '2025-03-10', time: '17:00-18:30', status: 'pending' }
    ],
    pastBookings: [
      { id: 3, turfName: 'Riverside Pitch', date: '2025-02-14', time: '19:00-20:00', status: 'completed' },
      { id: 4, turfName: 'Green Valley Turf', date: '2025-02-05', time: '16:00-17:00', status: 'completed' }
    ]
  });
                      ...
                      <li key={booking.id}>
                        <div className="px-4 py-4 sm:px-6">
                          <div className="flex items-center justify-between">
                            <p className="text-sm font-medium text-green-600 truncate">{booking.turfName}</p>
                  ...
                  <ul className="divide-y divide-gray-200">
                    {userData.pastBookings.map((booking) => (
                      <li key={booking.id}>
                        <div className="px-4 py-4 sm:px-6">
                          <div className="flex items-center justify-between">
                            <p className="text-sm font-medium text-gray-600 truncate">{booking.turfName}</p>
                            <div className="ml-2 flex-shrink-0 flex">
