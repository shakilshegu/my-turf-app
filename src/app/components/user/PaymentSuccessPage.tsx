    ...
    <div className="min-h-screen bg-gray-50 relative overflow-hidden">
      ...
      <div className="bg-green-500 py-12 px-4 text-white text-center relative overflow-hidden">
        ...
        >
          ...
          <h1
            className="text-4xl font-bold tracking-wider animate-slideUp opacity-0"
            style={{ animationDelay: "0.8s", animationFillMode: "forwards" }}
          >
            PAYMENT SUCCESSFUL!
          </h1>
          <p
            className="text-xl mt-2 animate-slideUp opacity-0"
      ...
      <div className="max-w-5xl mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div
            className="bg-white rounded-lg shadow-md p-6 transition-all duration-300 hover:shadow-lg animate-fadeIn opacity-0"
          ...
          >
            ...
            <div className="bg-blue-50 rounded-lg p-6 transition-all duration-300 hover:shadow-lg">
              ...
              <div
                className="bg-white border-2 border-dashed border-blue-300 p-4 text-center rounded relative overflow-hidden group cursor-pointer"
                onClick={() => copyReferralCode()}
              >
                <p className="text-xl font-mono font-bold tracking-wider relative z-10">
        ...
        {/* Action Buttons */}
        <div
          className="flex flex-col sm:flex-row justify-between items-center mt-8 pt-6 animate-fadeIn opacity-0"
          ...
          <div className="bg-gradient-to-r from-blue-500 to-green-500 rounded-lg p-8 text-white text-center relative overflow-hidden group">
            ...
            <div className="relative z-10">
              ...
              <h2 className="text-2xl font-bold mb-4">
                Invite Friends & Get ₹500 Off!
              </h2>
              <p className="mb-6">
                Share your referral code with friends and both of you get ₹500
