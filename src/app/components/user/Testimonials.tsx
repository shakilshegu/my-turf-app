  ...
  const testimonials = [
    {
      ...
      rating: 5,
      image: "/api/placeholder/80/80" // Placeholder for user image
    },
    {
    ...
    <section className="py-12 bg-gradient-to-r from-green-800 to-green-700 text-white">
      <div className="container mx-auto px-4">
        ...
        <p className="text-center text-green-100 mb-8 md:mb-12 max-w-2xl mx-auto text-sm md:text-base">
          Join thousands of sports enthusiasts who have found their perfect venue
        </p>
                  ...
                  <div className="flex mt-1">
                    {[...Array(5)].map((_, i) => (
                      <Star 
                        key={i} 
                        size={16} 
                        className={`${i < testimonial.rating ? "text-yellow-400 fill-yellow-400" : "text-gray-400"} mr-1`} 
                      />
                    ))}
                  </div>
                </div>
        ...
        <div className="md:hidden relative">
          <div className="overflow-hidden rounded-xl">
            <div 
              className="bg-white bg-opacity-10 backdrop-blur-lg p-5 rounded-xl shadow-lg"
            >
              <div className="flex items-center mb-4">
                <div className="mr-3">
                  <img 
                ...
                <div>
                  ...
                  <p className="text-green-200 text-sm">{testimonials[activeIndex].role}</p>
                  <div className="flex mt-1">
                    {[...Array(5)].map((_, i) => (
                      <Star 
                        key={i} 
                        size={14} 
                        className={`${i < testimonials[activeIndex].rating ? "text-yellow-400 fill-yellow-400" : "text-gray-400"} mr-1`} 
                      />
                    ))}
                  </div>
                </div>
              </div>
              <p className="italic mb-2 text-base">&ldquo;{testimonials[activeIndex].text}&rdquo;</p>
            </div>
          </div>
